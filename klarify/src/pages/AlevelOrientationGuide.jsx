...
const AlevelOrientationGuide = () => {
  ...
  return (
    <Layout noPadding={true}>
      <SEOHead
        title="What Can I Study After A-Level in Cameroon? | Klarify"
      ...
      <article className="bg-white py-12 px-6">
        <div className="max-w-2xl mx-auto text-slate-700 text-base sm:text-lg leading-relaxed space-y-6">
          ...
          <p>
            In Cameroon, it's easy to just follow what your friends are doing or
            choose a course because the name sounds fancy. But your A-Level
            subject combination is actually a map. If you follow it, it tells
          ...
          <p>
            Universities in Cameroon have clear rules for who they accept. You
          ...
          <p>
            Let's see what your stream qualifies you to study. Click your
            general stream below to see where you fit:
          </p>
          ...
          <p>
            Before you submit your admission papers, ask yourself these three
            basic questions:
          </p>
          <div className="space-y-4 text-sm sm:text-base">
            <p>
              <strong>🎒 Is it a Concours or Direct Entry?</strong> <br />
              Some schools require a separate entrance exam (concours) which is
              highly competitive. Always have a "direct entry" backup plan (a
              course you can get into immediately with just your GCE slip) so
              you don't waste a year.
            </p>
            <p>
              <strong>💸 Can we afford the tuition?</strong> <br />
              Public state universities cost 50,000 XAF a year, but private
              colleges and professional HND programs are more expensive. Talk to
              your family about the budget early.
            </p>
            <p>
              <strong>💼 Are there jobs?</strong> <br />
              Don't just choose a course because it sounds prestigious. Research
              if companies in Cameroon are actually hiring for that role, or if
              you can use the degree to start your own business.
            </p>
          </div>
          ...
          <p>
            Remember: Your A-Level results are just the starting block. It
            doesn't matter if you got 5 A's or 2 E's, what matters is that you
            choose a path where you can actually grow, learn, and build a
            career.
          </p>
