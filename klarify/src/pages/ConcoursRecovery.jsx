    ...
    <Layout noPadding={true}>
      ...
      <article className="bg-white dark:bg-slate-900 py-12 px-6">
        <div className="max-w-2xl mx-auto text-slate-700 dark:text-slate-300 text-base sm:text-lg leading-relaxed space-y-6">
          ...
          <p className="font-bold text-slate-900 dark:text-white">Your name wasn't there.</p>
          <p>
          ...
          <blockquote className="border-l-4 border-orange-500 pl-4 italic text-slate-800 dark:text-slate-200 font-medium my-8">
          ...
          <div className="p-5 bg-slate-50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-700/60 rounded-2xl flex gap-3 text-sm my-6">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 dark:text-slate-400 text-sm sm:text-base">
            <li>If you wanted <strong className="text-slate-800 dark:text-slate-200">Engineering</strong>, you can study <strong className="text-slate-800 dark:text-slate-200">Computer Science</strong>, Mathematics, Physics, or an HND in ICT.</li>
            <li>If you wanted <strong className="text-slate-800 dark:text-slate-200">Medicine</strong>, you can study <strong className="text-slate-800 dark:text-slate-200">Nursing</strong>, Medical Lab Sciences, Biochemistry, or Microbiology.</li>
            <li>If you wanted <strong className="text-slate-800 dark:text-slate-200">ENS (Teaching)</strong>, you can study standard Letters, History, or Science and apply for the concours again later.</li>
          </ul>

          {/* Clean Inline CTA */}
          <div className="my-8 p-6 bg-orange-50 border border-orange-200 rounded-2xl">
            <h4 className="font-bold text-slate-900 dark:text-white text-base">Not sure what courses you can do with your A-Levels?</h4>
          ...
          <ul className="list-decimal pl-6 space-y-2 text-slate-600 dark:text-slate-400 text-sm sm:text-base">
            <li><strong className="text-slate-800 dark:text-slate-200">Learn a practical skill:</strong> Master coding, graphic design, copywriting, tailoring, or mechanics.</li>
            <li><strong className="text-slate-800 dark:text-slate-200">Analyze your exam preparation:</strong> Identify exactly where you lost marks in the concours and practice past questions daily.</li>
            <li><strong className="text-slate-800 dark:text-slate-200">Build yourself:</strong> Read, volunteer, and learn basic communication skills.</li>
          </ul>
          ...
          <p>
            Remember: <strong className="text-slate-900 dark:text-white">There is always a next path.</strong> What matters is that you keep moving forward.
          </p>
          ...
          <div className="pt-8 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              ...
              <h4 className="font-extrabold text-slate-900 dark:text-white text-base mt-0.5">Let Klarify help you explore your options</h4>
            </div>
            <button
              onClick={() => navigate("/flow")}
...
export default ConcoursRecovery;
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-2xs">
              <h4 className="font-bold text-slate-900 dark:text-white text-sm mb-2">Still Need GCE Results?</h4>
            ...
            <div className="bg-slate-100 dark:bg-slate-800 p-5 rounded-2xl border border-slate-200 dark:border-slate-700">
              <h4 className="font-bold text-slate-800 dark:text-slate-200 text-xs uppercase tracking-wider mb-3">Guide Tags</h4>
              <div className="flex flex-wrap gap-1.5">
                {[
                  ...
                  <span
                    key={tag}
                    className="px-2 py-1 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-700/80 rounded text-[10px] font-semibold text-slate-500 dark:text-slate-400"
                  >
                    #{tag}
                  </span>
                ))}
