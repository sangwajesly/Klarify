  ...
  return (
    <Layout>
      ...
      <main className="py-8 pb-20 max-w-xl mx-auto">
            ...
            {(() => {
              ...
              return (
                <div className="flex items-center gap-3 text-xs text-slate-500 dark:text-slate-400">
                  <div
                    className={`px-3 py-1 rounded-full ${step1 ? "bg-green-50 text-green-600" : "bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400"}`}
                  >
                    Account{" "}
                    {step1 && <Check size={12} className="inline-block ml-2" />}
                  </div>
                  <div
                    className={`px-3 py-1 rounded-full ${step2 ? "bg-green-50 text-green-600" : "bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400"}`}
                  >
                    Institution{" "}
                    {step2 && <Check size={12} className="inline-block ml-2" />}
                  </div>
                  <div
                    className={`px-3 py-1 rounded-full ${step3 ? "bg-green-50 text-green-600" : "bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400"}`}
                  >
                    Programs
                  </div>
                </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 border border-slate-200/80 dark:border-slate-700/80 shadow-md">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pb-3 border-b border-slate-100 dark:border-slate-800 space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-xl text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:border-orange-500 transition-colors"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    value={formData.city}
                    onChange={handleChange}
                    className="w-full py-2.5 px-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-xl text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:border-orange-500 transition-colors"
                  >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-xl text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:border-orange-500 transition-colors"
                    />
                  </div>
                </div>
              </div>
