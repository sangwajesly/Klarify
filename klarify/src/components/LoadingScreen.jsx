...
const LoadingScreen = () => {
  return (
    ...
    >
      <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-xl flex flex-col items-center max-w-sm w-full">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm">Our system is matching your subjects and interests with the best academic paths.</p>
      </div>
    </motion.div>
  );
};
